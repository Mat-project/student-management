        ...
        <div className="container-fluid side-container">
            <div className="row side-row" >
                        ...
                        {students.map((stu) =>
                            ...
                            <tr key={stu.studentId}>
                                ...
                                <td>
                                    ...
                                    <UpdateStudentModal show={editModalShow} student={editStudent} setUpdated={setIsUpdated} onHide={EditModelClose}></UpdateStudentModal>
                                </td>
                            </tr>)}
                    </tbody>
                </Table>
                <ButtonToolbar>
                    ...
                    <AddStudentModel show={addModalShow} setupdated={setIsUpdated} onHide={AddModelClose}></AddStudentModel>
                </ButtonToolbar>
